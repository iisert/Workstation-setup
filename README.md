...
3. Installed Tailscale VPN to access PC using machine names.
    1. Signed up using the complexnetworksanddynamics@gmail.com
    2. Created a windows service for the app to remove restriction of logon after reboot using http://runasservice.com/
